  ...
  return (
    <div ref={ref}>
      ...
      <section className="mb-8">
        ...
        <div className="mb-6">
          <div className="font-medium resume-company">Signify Health/CVS, Dallas</div>
        ...
        <div className="mb-6">
          <div className="font-medium resume-company">Resilience Lab, New York City</div>
        ...
        <div className="mb-6">
          <div className="font-medium resume-company">Pearl Health, Boston, NYC</div>
        ...
        <div className="mb-6">
          <div className="font-medium resume-company">Bravado Health, West Palm Beach</div>
        ...
        <div className="mb-6">
          <div className="font-medium resume-company">VetsEZ, San Diego</div>
...
const Resume = () => {
  ...
  return (
    <div className="resume-page" style={{ fontFamily: "'Bricolage Grotesque', sans-serif", margin: 0, padding: 0, background: 'var(--bg-primary)', color: 'var(--text-secondary)' }}>
      <Helmet>
        <title>Resume | James Young - Product Design Leader & AI Prompt Engineer</title>
      ...
      <div className="max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="mb-8 no-print">
          <div className="mt-2">
            <button
              className="border px-4 py-2 rounded-md btn-text hover:bg-gray-200 transition-colors resume-print-btn"
